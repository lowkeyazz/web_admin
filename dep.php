<html>
  ...
  <body>
    <header class="maindep">
      ...
      <div class="D2">
        <img class="I1" src="image/icondep.jpg" alt="walo" />
	...
	<?php
		...
		if(isset($_POST["sign_in"]))
		{
			...
			$select_user="SELECT * FROM chef_departement WHERE username='$username' AND password='$password'";
			...
			if($check_user==1)
			{
				...
				$get_user="select * from chef_departement where username='$user'";
				$run_user=mysqli_query($con, $get_user);
				$row=mysqli_fetch_array($run_user);
				$nom=$row['Nom'];
				echo"<script>window.open('chef_departement_interface.php?username=$nom','_self') </script>";
